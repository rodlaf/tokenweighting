...
position-dependent baseline. We therefore do \emph{not} position critic-based
variants as part of the proposed method, and we leave a full comparison against
